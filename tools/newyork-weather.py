#!/usr/bin/env python3
"""
New York Weather Checker
Fetches current weather data for New York City using Open-Meteo API (no API key required)
"""
...
def format_weather(data):
    ...
    output = f"""
╔════════════════════════════════════════╗
║  New York Weather - {datetime.now().strftime("%H:%M")}         ║
╠════════════════════════════════════════╣
║  {description:36} ║
║                                        ║
